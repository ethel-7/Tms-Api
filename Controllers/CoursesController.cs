    ...
    LinkGenerator linkGenerator) : ControllerBase
{
    ...
    public async Task<IActionResult> GetCourseById(int id, CancellationToken ct)
    {
        ...
        // Build links using LinkGenerator
        var links = new List<LinkDto>
        {
            ...
            new(linkGenerator.GetPathByAction(HttpContext, action: "GetEnrollments", controller: "Enrollments", values: new { courseId = id })!, "enrollments", "GET")
        };

        // Conditional enroll link if course has capacity
        if (course.EnrollmentCount < course.MaxCapacity)
        {
            links.Add(new(linkGenerator.GetPathByAction(HttpContext, action: "GetEnrollments", controller: "Enrollments", values: new { courseId = id })!, "enroll", "POST"));
        }
